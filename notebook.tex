...
\codefalse
    ...
    \hypertarget{textbook-questions}{%
\subsection{Textbook questions}\label{textbook-questions}}

    \hypertarget{c}{%
\subsubsection{6.6 (c)}\label{c}}
...
plt.ylabel(r'$\frac{C_V(T) k}{N (\varepsilon_2 - \varepsilon_1)^2} $', labelpad=30, rotation=0, fontsize=14)
plt.title(r'Relationship between heat capacity ($C_V(T)$) and temperature ($T$)', fontsize=14)
plt.show()
\end{minted}
\end{tcolorbox}
\codefalse
